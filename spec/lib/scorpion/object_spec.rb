...
describe Scorpion::Object do
  ...
  describe ".spawn" do
    it "can spawn" do
      mamal = Test::Object::Mammal.spawn(hunt, "mouse", "rodent", name: "name")
      expect(mamal).to(be_a(Test::Object::Mammal))
    end
  ...
  describe "accessors" do
    let(:object) do
      Test::Object::Mammal.spawn(hunt, "harry", "jim", name: "name", manager: double)
    end
